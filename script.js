...
if (window.innerWidth > 820 && navLinks.classList.contains('open')) fecharMenu();
});
...
(function aprimorarCtaFinal(){
  ...
  if (!document.getElementById('ctaFinalImersivoStyle')) {
    ...
    style.textContent = `
      ...
      .cta-panel::before{content:''!important;position:absolute!important;inset:0!important;background:radial-gradient(90% 78% at 8% 96%,rgba(91,43,19,.16) 0%,rgba(77,34,14,.08) 18%,rgba(53,23,10,.035) 34%,transparent 54%)!important;pointer-events:none!important;z-index:0!important;animation:none!important;transform:none!important;transition:none!important;opacity:1!important}
      .cta-photo-main{display:none!important}
      ...
      @media(max-width:820px){
        ...
        .cta-panel{min-height:520px!important;padding:54px 38px!important;justify-content:flex-end!important;background:linear-gradient(180deg,rgba(9,7,5,.03) 0%,rgba(9,7,5,.06) 24%,rgba(9,7,5,.22) 44%,rgba(9,7,5,.58) 66%,rgba(9,7,5,.88) 84%,#090705 100%),url('assets/cta-final-mobile.webp') 50% 14%/cover no-repeat,#090705!important}
      ...
      @media(max-width:560px){
        .cta-panel{min-height:540px!important;padding:42px 24px!important;border-radius:16px!important;background:linear-gradient(180deg,rgba(9,7,5,.03) 0%,rgba(9,7,5,.08) 24%,rgba(9,7,5,.28) 46%,rgba(9,7,5,.62) 68%,rgba(9,7,5,.90) 84%,#090705 100%),url('assets/cta-final-mobile.webp') 50% 12%/cover no-repeat,#090705!important}
