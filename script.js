...
(function aprimorarCtaFinal(){
  ...
  if (!document.getElementById('ctaFinalImersivoStyle')) {
    ...
    style.textContent = `
      ...
      .cta-panel::before{content:''!important;position:absolute!important;inset:0!important;background:radial-gradient(90% 78% at 8% 96%,rgba(91,43,19,.22) 0%,rgba(77,34,14,.12) 18%,rgba(53,23,10,.055) 34%,transparent 54%),radial-gradient(74% 88% at 40% 82%,rgba(58,27,12,.08) 0%,rgba(42,18,8,.035) 28%,transparent 50%),linear-gradient(90deg,#080604 0%,#090705 18%,#0a0705 34%,#0b0806 52%,#0d0907 70%,#0f0a07 86%,#110b08 100%)!important;pointer-events:none!important;z-index:0!important}
      ...
      @media(max-width:820px){
        ...
        .cta-panel::before{inset:0!important;background:radial-gradient(100% 72% at 15% 96%,rgba(91,43,19,.18) 0%,rgba(65,29,12,.08) 24%,transparent 48%),linear-gradient(180deg,#080604 0%,#090705 30%,#0b0806 62%,#0f0907 100%)!important;filter:none!important;opacity:1!important;-webkit-mask-image:none!important;mask-image:none!important}
      ...
      @media(max-width:560px){
        ...
        .cta-panel::before{inset:0!important;background:radial-gradient(105% 78% at 12% 96%,rgba(91,43,19,.19) 0%,rgba(64,28,12,.08) 24%,transparent 50%),linear-gradient(180deg,#080604 0%,#090705 28%,#0b0806 60%,#100907 100%)!important;filter:none!important;opacity:1!important}
