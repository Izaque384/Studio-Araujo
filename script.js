...
(function aprimorarCtaFinal(){
  ...
  if (!document.getElementById('ctaFinalImersivoStyle')) {
    ...
    style.textContent = `
      ...
      .cta-panel{position:relative!important;min-height:410px!important;padding:72px 64px!important;display:flex!important;flex-direction:column!important;justify-content:center!important;align-items:flex-start!important;text-align:left!important;border:1px solid rgba(201,162,75,.22)!important;border-radius:20px!important;overflow:hidden!important;background-color:#0e0d0b!important;background-image:linear-gradient(90deg,rgba(14,13,11,.98) 0%,rgba(14,13,11,.94) 29%,rgba(14,13,11,.74) 48%,rgba(14,13,11,.28) 68%,rgba(14,13,11,.18) 100%),url('assets/cta-final.webp')!important;background-repeat:no-repeat!important;background-size:100% 100%,auto 155%!important;background-position:center,73% 45%!important;box-shadow:0 30px 80px rgba(0,0,0,.28)!important}
      .cta-panel::before{content:''!important;position:absolute!important;inset:-4% -7%!important;background-image:linear-gradient(90deg,rgba(14,13,11,.88) 0%,rgba(14,13,11,.58) 22%,rgba(14,13,11,.12) 46%,rgba(14,13,11,0) 58%,rgba(14,13,11,0) 68%,rgba(14,13,11,.30) 82%,rgba(14,13,11,.58) 100%),url('assets/cta-final.webp')!important;background-repeat:no-repeat!important;background-size:100% 100%,auto 178%!important;background-position:center,73% 45%!important;filter:blur(18px) brightness(.88) saturate(.88)!important;opacity:.56!important;transform:scaleX(1.16)!important;transform-origin:center!important;-webkit-mask-image:linear-gradient(90deg,#000 0%,rgba(0,0,0,.78) 22%,transparent 48%,transparent 66%,rgba(0,0,0,.62) 82%,#000 100%)!important;mask-image:linear-gradient(90deg,#000 0%,rgba(0,0,0,.78) 22%,transparent 48%,transparent 66%,rgba(0,0,0,.62) 82%,#000 100%)!important;pointer-events:none!important;z-index:0!important}
      ...
      @media(max-width:820px){
        ...
        .cta-panel::before{inset:-3% -5%!important;background-image:linear-gradient(180deg,rgba(14,13,11,.38),rgba(14,13,11,.18) 45%,rgba(14,13,11,.58)),url('assets/cta-final.webp')!important;background-size:100% 100%,auto 132%!important;background-position:center,68% 46%!important;filter:blur(14px) brightness(.88) saturate(.9)!important;opacity:.48!important;transform:scaleX(1.10)!important;-webkit-mask-image:linear-gradient(90deg,#000 0%,rgba(0,0,0,.72) 18%,transparent 42%,transparent 70%,rgba(0,0,0,.58) 84%,#000 100%)!important;mask-image:linear-gradient(90deg,#000 0%,rgba(0,0,0,.72) 18%,transparent 42%,transparent 70%,rgba(0,0,0,.58) 84%,#000 100%)!important}
      ...
      @media(max-width:560px){
        ...
        .cta-panel::before{inset:-2% -4%!important;background-size:100% 100%,auto 118%!important;background-position:center,58% 36%!important;filter:blur(12px) brightness(.9) saturate(.92)!important;opacity:.44!important;transform:scaleX(1.08)!important}
