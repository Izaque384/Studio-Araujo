...
(function aprimorarCtaFinal(){
  ...
  if (!document.getElementById('ctaFinalImersivoStyle')) {
    ...
    style.textContent = `
      ...
      .cta-panel::before{content:''!important;position:absolute!important;top:0!important;right:0!important;bottom:0!important;left:42%!important;background:linear-gradient(90deg,rgba(14,13,11,1) 0%,rgba(14,13,11,.98) 8%,rgba(14,13,11,.90) 18%,rgba(14,13,11,.68) 30%,rgba(14,13,11,.38) 42%,rgba(14,13,11,.12) 52%,rgba(14,13,11,0) 64%),url('assets/cta-final.webp') no-repeat right center/auto 155%!important;pointer-events:none!important;z-index:0!important}
      ...
      @media(max-width:820px){
        ...
        .cta-panel::before{left:0!important;background:linear-gradient(180deg,rgba(14,13,11,.16) 0%,rgba(14,13,11,.08) 24%,rgba(14,13,11,.46) 62%,rgba(14,13,11,.90) 100%),url('assets/cta-final.webp') no-repeat 68% 46%/auto 120%!important}
      ...
      @media(max-width:560px){
        ...
        .cta-panel::before{left:0!important;background:linear-gradient(180deg,rgba(14,13,11,.18) 0%,rgba(14,13,11,.10) 20%,rgba(14,13,11,.54) 62%,rgba(14,13,11,.94) 100%),url('assets/cta-final.webp') no-repeat 58% 36%/auto 105%!important}
