...
(function aprimorarCtaFinal(){
  ...
  if (!document.getElementById('ctaFinalImersivoStyle')) {
    ...
    style.textContent = `
      ...
      .cta-panel{position:relative!important;min-height:410px!important;padding:72px 64px!important;display:flex!important;flex-direction:column!important;justify-content:center!important;align-items:flex-start!important;text-align:left!important;border:1px solid rgba(201,162,75,.22)!important;border-radius:20px!important;overflow:hidden!important;background-color:#0e0d0b!important;background-image:linear-gradient(90deg,rgba(14,13,11,.98) 0%,rgba(14,13,11,.94) 29%,rgba(14,13,11,.74) 48%,rgba(14,13,11,.28) 68%,rgba(14,13,11,.10) 82%,rgba(14,13,11,0) 100%),url('assets/cta-final.webp')!important;background-repeat:no-repeat!important;background-size:100% 100%,auto 155%!important;background-position:center,73% 45%!important;box-shadow:0 30px 80px rgba(0,0,0,.28)!important}
      .cta-panel::before{content:''!important;position:absolute!important;inset:-9% -24%!important;background:url('assets/cta-final.webp') center/cover no-repeat!important;filter:blur(28px) brightness(.84) saturate(.9)!important;opacity:.74!important;transform:scaleX(1.36)!important;transform-origin:center!important;-webkit-mask-image:linear-gradient(90deg,#000 0%,rgba(0,0,0,.96) 20%,rgba(0,0,0,.58) 36%,transparent 52%,transparent 68%,rgba(0,0,0,.78) 82%,#000 100%)!important;mask-image:linear-gradient(90deg,#000 0%,rgba(0,0,0,.96) 20%,rgba(0,0,0,.58) 36%,transparent 52%,transparent 68%,rgba(0,0,0,.78) 82%,#000 100%)!important;pointer-events:none!important;z-index:0!important}
      .cta-panel::after{content:''!important;position:absolute!important;inset:0!important;background:linear-gradient(90deg,rgba(14,13,11,1) 0%,rgba(14,13,11,.99) 12%,rgba(14,13,11,.95) 24%,rgba(14,13,11,.82) 36%,rgba(14,13,11,.58) 48%,rgba(14,13,11,.30) 58%,rgba(14,13,11,.10) 68%,rgba(14,13,11,0) 78%)!important;pointer-events:none!important;z-index:1!important}
      ...
      @media(max-width:820px){
        ...
        .cta-panel::before{inset:-7% -18%!important;background:url('assets/cta-final.webp') center/cover no-repeat!important;filter:blur(22px) brightness(.86) saturate(.92)!important;opacity:.66!important;transform:scaleX(1.28)!important;-webkit-mask-image:linear-gradient(90deg,#000 0%,rgba(0,0,0,.82) 22%,transparent 46%,transparent 70%,rgba(0,0,0,.72) 84%,#000 100%)!important;mask-image:linear-gradient(90deg,#000 0%,rgba(0,0,0,.82) 22%,transparent 46%,transparent 70%,rgba(0,0,0,.72) 84%,#000 100%)!important}
        .cta-panel::after{background:linear-gradient(180deg,rgba(14,13,11,.28) 0%,rgba(14,13,11,.10) 28%,rgba(14,13,11,.34) 55%,rgba(14,13,11,.88) 100%)!important}
      ...
      @media(max-width:560px){
        ...
        .cta-panel::before{inset:-5% -14%!important;background:url('assets/cta-final.webp') center/cover no-repeat!important;filter:blur(18px) brightness(.88) saturate(.94)!important;opacity:.60!important;transform:scaleX(1.20)!important}
